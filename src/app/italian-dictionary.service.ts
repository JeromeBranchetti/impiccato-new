...
export class ItalianDictionaryService {
  italianDictionary: string[] = 
  ["a",
  "abate",
  "abate",
  "abbacchiato",
  ...
  getWord() {
    const randIndex = Math.floor(Math.random()*this.italianDictionary.length);
    return this.italianDictionary[randIndex].split('');
  }
}
